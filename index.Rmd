...
Otherwise, I can recommend the relevant chapters in @gries2013statistics, which provide a gentle introduction to using R.
...
If you have any questions about the information presented here or any other matters related to the class, please to do not hesitate to drop me a line via [email](mailto:maik.thalmann@gmail.com?subject=[SummerSchool]%20). 
